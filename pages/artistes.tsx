...
export default function Artistes() {
  return (
    <Layout>
      ...
      <p>
        Découvrez les créateurs et créatrices collaborant avec PALÉOPHONE.
      </p>
        ...
        {featured.map(artist => (
          <div key={artist.slug}>
            ...
            <p style={{ fontSize: '14px', color: '#666', margin: 0 }}>
              Artiste collaborant avec PALÉOPHONE
            </p>
          </div>
        ))}
      </div>
      ...
      <div style={{ borderTop: '1px solid #eee', paddingTop: '40px' }}>
        <h3 style={{ fontSize: '13px', color: '#999', fontWeight: 'normal', marginBottom: '20px' }}>Autres artistes</h3>
